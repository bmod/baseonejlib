...
public class SettingsDialog extends javax.swing.JDialog {
	...
	private SettingsDialog(final java.awt.Frame parent, final boolean modal,
		...
		directoryListEditor.setDirectories(db.getMediaSources());

		directoryListEditor.addListener(new DirectoryListEditor.Listener() {

			@Override
			public void dataChanged() {
				db.setMediaSources(directoryListEditor.getDirectories());
			}
		});

		fileTypeEditor1.setFileTypes(db.getFileTypes());

		fileTypeEditor1.addListener(new FileTypeListEditor.Listener() {

			@Override
			public void dataChanged() {
				db.setFileTypes(fileTypeEditor1.getFileTypes());
			}
		});
	...
	private void initComponents() {
		...
		layout.setHorizontalGroup(layout.createParallelGroup(
				...
				jTabbedPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 311,
				Short.MAX_VALUE));
		layout.setVerticalGroup(layout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addComponent(
				jTabbedPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 313,
				Short.MAX_VALUE));
