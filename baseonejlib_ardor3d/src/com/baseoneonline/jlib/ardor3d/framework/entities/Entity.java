...
public class Entity implements Savable {
	...
	public void addComponent(final Component c)
	{
		...
		assert !hasComponent(type) : "Component type " + c.getClass().getName() + "  already added to: " + this;
	...
	public <T extends Component> T getComponent(final Class<T> type)
	{
		...
		assert comp != null : "Component of type " + type.getName() + " not found on entity: " + getName();
	...
	public void write(final OutputCapsule capsule) throws IOException
	{
		...
		capsule.writeSavableList(new ArrayList<Savable>(components.values()), "components", null);
	}
	...
	public void read(final InputCapsule capsule) throws IOException
	{
		...
		components.clear();
		final List<Component> components = capsule.readSavableList("components", Collections.<Component> emptyList());
