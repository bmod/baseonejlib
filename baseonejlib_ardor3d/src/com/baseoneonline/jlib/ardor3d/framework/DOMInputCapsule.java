...
/**
 * This is a copy of the {@link com.ardor3d.util.export.xml.DOMInputCapsule},
 * with only the access modifiers changed.
 * 
 * @author bmod
 * 
 */
class DOMInputCapsule implements InputCapsule {

	private final Document _doc;
	protected Element _currentElem;
	private boolean _isAtRoot = true;
	private final Map<String, Savable> _referencedSavables = new HashMap<String, Savable>();
	HashMap<String, Class<? extends Savable>> _tagMap;

	public DOMInputCapsule(final Document doc,
			HashMap<String, Class<? extends Savable>> tagMap) {
		_doc = doc;
		_tagMap = tagMap;
	...
	private Element findChildElement(final Element parent, final String name) {
		...
		Node ret = parent.getFirstChild();
		while (ret != null
				&& (!(ret instanceof Element) || !ret.getNodeName()
						.equals(name))) {
			ret = ret.getNextSibling();
		}
		return (Element) ret;
	...
	@Override
	public byte readByte(final String name, final byte defVal)
			throws IOException {
		byte ret = defVal;
		try {
	...
	@Override
	public byte[] readByteArray(final String name, final byte[] defVal)
			throws IOException {
		byte[] ret = defVal;
		try {
			Element tmpEl;
	...
	@Override
	public byte[][] readByteArray2D(final String name, final byte[][] defVal)
			throws IOException {
		byte[][] ret = defVal;
		try {
			Element tmpEl;
	...
	@Override
	public int[] readIntArray(final String name, final int[] defVal)
			throws IOException {
		int[] ret = defVal;
		try {
			Element tmpEl;
	...
	@Override
	public int[][] readIntArray2D(final String name, final int[][] defVal)
			throws IOException {
		int[][] ret = defVal;
		try {
			Element tmpEl;
	...
	@Override
	public float readFloat(final String name, final float defVal)
			throws IOException {
		float ret = defVal;
		try {
			final String s = _currentElem.getAttribute(name);
	...
	@Override
	public float[] readFloatArray(final String name, final float[] defVal)
			throws IOException {
		float[] ret = defVal;
		try {
			Element tmpEl;
	...
	@Override
	public float[][] readFloatArray2D(final String name, final float[][] defVal)
			throws IOException {
		float[][] ret = defVal;
		try {
			Element tmpEl;
			...
			final int size_outer = Integer.parseInt(tmpEl
					.getAttribute("size_outer"));
			final int size_inner = Integer.parseInt(tmpEl
					.getAttribute("size_outer"));
	...
	@Override
	public double readDouble(final String name, final double defVal)
			throws IOException {
		double ret = defVal;
		try {
			final String s = _currentElem.getAttribute(name);
	...
	@Override
	public double[] readDoubleArray(final String name, final double[] defVal)
			throws IOException {
		double[] ret = defVal;
		try {
			Element tmpEl;
	...
	@Override
	public double[][] readDoubleArray2D(final String name,
			final double[][] defVal) throws IOException {
		double[][] ret = defVal;
		try {
			Element tmpEl;
			if (name != null) {
	...
	@Override
	public long readLong(final String name, final long defVal)
			throws IOException {
		long ret = defVal;
		try {
			final String s = _currentElem.getAttribute(name);
	...
	@Override
	public long[] readLongArray(final String name, final long[] defVal)
			throws IOException {
		long[] ret = defVal;
		try {
			Element tmpEl;
	...
	@Override
	public long[][] readLongArray2D(final String name, final long[][] defVal)
			throws IOException {
		long[][] ret = defVal;
		try {
			Element tmpEl;
	...
	@Override
	public short readShort(final String name, final short defVal)
			throws IOException {
		short ret = defVal;
		try {
			final String s = _currentElem.getAttribute(name);
	...
	@Override
	public short[] readShortArray(final String name, final short[] defVal)
			throws IOException {
		short[] ret = defVal;
		try {
			Element tmpEl;
	...
	@Override
	public short[][] readShortArray2D(final String name, final short[][] defVal)
			throws IOException {
		short[][] ret = defVal;
		try {
			Element tmpEl;
	...
	@Override
	public boolean readBoolean(final String name, final boolean defVal)
			throws IOException {
		boolean ret = defVal;
		try {
			final String s = _currentElem.getAttribute(name);
	...
	@Override
	public boolean[] readBooleanArray(final String name, final boolean[] defVal)
			throws IOException {
		boolean[] ret = defVal;
		try {
			Element tmpEl;
	...
	@Override
	public boolean[][] readBooleanArray2D(final String name,
			final boolean[][] defVal) throws IOException {
		boolean[][] ret = defVal;
		try {
			Element tmpEl;
			if (name != null) {
			...
			for (int i = 0; i < nodes.getLength(); i++) {
				...
				if (n instanceof Element && n.getNodeName().contains("array")) {
					if (strIndex < size) {
						tmp[strIndex++] = readBooleanArray(n.getNodeName(),
								null);
					} else {
						throw new IOException(
								"String array contains more elements than specified!");
	...
	@Override
	public String readString(final String name, final String defVal)
			throws IOException {
		String ret = defVal;
		try {
	...
	@Override
	public String[] readStringArray(final String name, final String[] defVal)
			throws IOException {
		String[] ret = defVal;
		try {
			Element tmpEl;
			...
			for (int i = 0; i < nodes.getLength(); i++) {
				...
				if (n instanceof Element && n.getNodeName().contains("String")) {
					if (strIndex < size) {
						tmp[strIndex++] = ((Element) n).getAttributeNode(
								"value").getValue();
					} else {
						throw new IOException(
								"String array contains more elements than specified!");
	...
	@Override
	public String[][] readStringArray2D(final String name,
	...
	@Override
	public BitSet readBitSet(final String name, final BitSet defVal)
			throws IOException {
		BitSet ret = defVal;
		try {
	...
	@Override
	public Savable readSavable(final String name, final Savable defVal)
			throws IOException {
		Savable ret = defVal;
	...
	private String resolveClassName(String shortName) {
		if (_tagMap.containsKey(shortName))
			return _tagMap.get(shortName).getName();
		return shortName;
	}
	...
	private Savable readSavableFromCurrentElem(final Savable defVal)
		...
		if (reference.length() > 0) {
			...
			className = resolveClassName(className.toLowerCase());

			try {
				@SuppressWarnings("unchecked")
				final Class<? extends Savable> clazz = (Class<? extends Savable>) Class
						.forName(className);
				final SavableFactory ann = clazz
						.getAnnotation(SavableFactory.class);
				if (ann == null) {
					tmp = clazz.newInstance();
				} else {
					tmp = (Savable) clazz.getMethod(ann.factoryMethod(),
				...
				Logger.getLogger(getClass().getName()).logp(Level.SEVERE,
						this.getClass().toString(),
	...
	private TextureState readTextureStateFromCurrent() {
		...
		try {
			...
			Logger.getLogger(DOMInputCapsule.class.getName()).log(Level.SEVERE,
					null, e);
		}
		_currentElem = el;
		return ret;
	...
	private Savable[] readRenderStateList(final Element fromElement,
			final Savable[] defVal) {
		Savable[] ret = defVal;
		try {
			...
			while (_currentElem != null) {
				...
				if (el.getNodeName().equals(
						"com.ardor3d.scene.state.TextureState")) {
	...
	@Override
	public Savable[] readSavableArray(final String name, final Savable[] defVal)
			throws IOException {
		Savable[] ret = defVal;
		try {
	...
	@Override
	public Savable[][] readSavableArray2D(final String name,
			final Savable[][] defVal) throws IOException {
		Savable[][] ret = defVal;
		try {
			final Element tmpEl = findChildElement(_currentElem, name);
			if (tmpEl == null) {
	...
	private int getChildCount(Element elm) {
		if (elm.hasAttribute("size"))
			return Integer.parseInt(elm.getAttribute("size"));
	...
	@Override
	@SuppressWarnings("unchecked")
	public <E extends Savable> List<E> readSavableList(final String name,
			final List<E> defVal) throws IOException {
		List<E> ret = defVal;
		try {
			final Element tmpEl = findChildElement(_currentElem, name);
			if (tmpEl == null) {
	...
	@Override
	@SuppressWarnings("unchecked")
	public <E extends Savable> List<E>[] readSavableListArray(
			final String name, final List<E>[] defVal) throws IOException {
		List<E>[] ret = defVal;
		try {
			final Element tmpEl = findChildElement(_currentElem, name);
			if (tmpEl == null) {
	...
	public <E extends Savable> List<E>[][] readSavableListArray2D(
			final String name, final List<E>[][] defVal) throws IOException {
		List<E>[][] ret = defVal;
		try {
			final Element tmpEl = findChildElement(_currentElem, name);
			...
			for (int i = 0; i < size; i++) {
				final List[] arr = readSavableListArray(
						"SavableArrayListArray_" + i, null);
				tmp[i] = arr;
			}
			ret = tmp;
			_currentElem = (Element) tmpEl.getParentNode();
	...
	@Override
	public List<FloatBuffer> readFloatBufferList(final String name,
			final List<FloatBuffer> defVal) throws IOException {
	...
	@Override
	@SuppressWarnings("unchecked")
	public <K extends Savable, V extends Savable> Map<K, V> readSavableMap(
			final String name, final Map<K, V> defVal) throws IOException {
		Map<K, V> ret;
		Element tempEl;
	...
	@Override
	@SuppressWarnings("unchecked")
	public <V extends Savable> Map<String, V> readStringSavableMap(
			final String name, final Map<String, V> defVal) throws IOException {
	 ...
	 */
	@Override
	public FloatBuffer readFloatBuffer(final String name,
			final FloatBuffer defVal) throws IOException {
		...
		try {
			...
			if (size > 0) {
				final String[] strings = tmpEl.getAttribute("data").split(
						"\\s+");
	...
	@Override
	public IntBuffer readIntBuffer(final String name, final IntBuffer defVal)
			throws IOException {
	...
	@Override
	public ByteBuffer readByteBuffer(final String name, final ByteBuffer defVal)
			throws IOException {
	...
	@Override
	public ShortBuffer readShortBuffer(final String name,
			final ShortBuffer defVal) throws IOException {
	...
	@Override
	public List<ByteBuffer> readByteBufferList(final String name,
			final List<ByteBuffer> defVal) throws IOException {
	...
	@Override
	public <T extends Enum<T>> T readEnum(final String name,
			final Class<T> enumType, final T defVal) throws IOException {
		T ret = defVal;
		try {
	...
	@Override
	@SuppressWarnings("unchecked")
	public <T extends Enum<T>> T[] readEnumArray(final String name,
			final Class<T> enumType, final T[] defVal) throws IOException {
