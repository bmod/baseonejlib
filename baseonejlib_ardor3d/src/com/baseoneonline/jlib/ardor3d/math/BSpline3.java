...
public class BSpline3 extends Curve3
{
	...
	public Vector3 getPoint(final double t, final Vector3 store)
	{
		...
		return store.set(
				curveFunction(a.getX(), b.getX(), c.getX(), d.getX(), v),
				curveFunction(a.getY(), b.getY(), c.getY(), d.getY(), v),
				curveFunction(a.getZ(), b.getZ(), c.getZ(), d.getZ(), v));
	}
	...
	public Vector3 getVelocity(final double t, final Vector3 store)
	{
		...
		return store
				.set(curveFunctionDerived(a.getX(), b.getX(), c.getX(),
						d.getX(), v),
						curveFunctionDerived(a.getY(), b.getY(), c.getY(),
								d.getY(), v),
						curveFunctionDerived(a.getZ(), b.getZ(), c.getZ(),
								d.getZ(), v));
	...
	private static double curveFunction(double a, double b, double c, double d,
			double t)
	{
		final double it = 1 - t;
		double t2 = t * t;
	...
	private static double curveFunctionDerived(double a, double b, double c,
			double d, double t)
	{
		final double it = 1 - t;
